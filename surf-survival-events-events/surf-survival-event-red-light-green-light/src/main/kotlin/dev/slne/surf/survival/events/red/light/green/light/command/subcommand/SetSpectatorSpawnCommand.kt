...
fun CommandAPICommand.setSpectatorSpawnCommand() = subcommand("set-spectator-spawn") {
    ...
    playerExecutor { player, args ->
        ...
        val spectatorSpawn = location.setRotation(rotation.yaw, rotation.pitch)

        RlglConfig.edit {
            this.spectatorSpawn = spectatorSpawn.toGamePosition()
        }
        ...
        player.sendText {
            ...
            appendSpace()
            variableValue(spectatorSpawn.readableString(true))
        }
    }
}